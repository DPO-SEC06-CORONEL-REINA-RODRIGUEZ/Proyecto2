		...
		public void actionPerformed(ActionEvent e) { 
				    ...
				    public void actionPerformed(ActionEvent e)
					{
				    	...
				    	if (Pos==17)
				    	{
				    		...
				    		creacion.dispatchEvent(new WindowEvent(crearEquipo, WindowEvent.WINDOW_CLOSING));
					    		...
					    		choseTeam.setSize(new Dimension(370,100));
										...
										if (e.getSource() == combo1) {
								            String seleccionado=(String)combo1.getSelectedItem();
										            ...
										            if (seleccionado != "--SELECCIONA--") {
											            ...
											            VentanaPropietario ventanaProp  =new VentanaPropietario(user, seleccionado, equipoSelected);
		    ...
		    if (c==1)
		    {
		    	...
		    	if (ListaEquipos!=null)
		    		{for (EquipoFantasia eq: ListaEquipos)
						    	{
						    		if (eq.getNombre()=="Equipo Super Campeones")
						    		{equipoSelected = eq;}
						    	}
		    		}
				VentanaPropietario ventanaProp  =new VentanaPropietario(user, "Equipo Super Campeones", equipoSelected);
				ventanaProp.setVisible(true);
				ventanaProp.pack();
