	            	            ...
	            	            try {
	            	                ...
	            	                switch (opcion2) {
	            	                    ...
	            	                    case 3:
	            	                        ...
	            	                        break;
	            	                    default:
	            	                        System.out.println("\nSyntax Error: Ingrese n�meros entre 1 y 3");
	            	                }
        	            ...
        	            try {
        	                ...
        	                switch (opcion4) {
        	                    ...
        	                    */    
        	                    ...
        	                    case 5://FALTA AGREGAR EL DINERO AL DUEnO DEL JUGADOR - Miguel: t�cnicamente es al equipo el que tiene el dinero
        	                    ...
        	                    case 6:
        	                        ...
        	                        break;
        	                    default:
        	                        System.out.println("\nSyntax Error: Ingrese n�meros entre 1 y 7");
        	                }
        	            } catch (InputMismatchException e) {
        	                System.out.println("Debes insertar un n�mero");
        	                sn4.next();
    	                ...
    	                switch (opcion4) {
    	                    case 1:
    	                    	System.out.print("Para iniciar, tenga en cuenta que "
    	                    			+ "\nlos archivos que ser�n solicitados deber�"
    	                    	...
    	                    	System.out.print("Ahora, escoja un 'key' con el que "
    	                    			+ "\nidentific� la temporada (e.g. mundial2018): \n");
